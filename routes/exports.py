...
def _rows_sales():
    ...
    headers = [
        "التاريخ", "اليوم", "رقم البون", "النوع", "من", "إلى", "المسافة", "اسم السائق",
        "رقم الجرار", "التكعيب", "الخصم", "صافي الكمية", "السعر", "الإجمالي",
        "عهدة ودفعات", "المتبقي", "الفترة",
    ]
    rows = []
    total_amount = 0.0
    advances = 0.0
