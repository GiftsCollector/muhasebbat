(function () {
  ...
  function initSearchableSelects(root) {
    ...
    scope.querySelectorAll("select.form-select, select.js-searchable-select").forEach(function (select) {
      ...
      const observer = new MutationObserver(function (mutations) {
        mutations.forEach(function (mutation) {
          mutation.addedNodes.forEach(function (node) {
            ...
            if (node.matches && node.matches("select.form-select, select.js-searchable-select")) {
              bindSelect(node);
            }
            if (node.querySelectorAll) initSearchableSelects(node);
          });
        });
      });
