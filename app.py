...
from models import (
    ...
    DocumentAttachment, ROLE_ADMIN, ROLE_ACCOUNTANT, ROLE_DATA_ENTRY, ROLE_PROJECT_MANAGER,
    ROLE_LABELS,
)
...
if IS_PRODUCTION:
    if not SECRET_KEY or SECRET_KEY == "dev-secret-key-2024":
        raise RuntimeError("SECRET_KEY إلزامي في بيئة التشغيل. عيّنه في متغيرات البيئة قبل التشغيل.")
