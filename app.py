...
from flask import Flask, render_template, request, url_for, flash, redirect, session, g, send_file, abort, Response
...
from services.authz import (
    ...
    endpoint_allowed, first_allowed_endpoint, normalize_legacy_role, require_perm,
    sanitize_permissions, user_can,
)
...
def update_user_permissions(user_id):
    ...
    user.permissions_json = dump_permissions(sanitize_permissions(selected, user))
    db.session.commit()
