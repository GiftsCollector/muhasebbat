...
from models import (
    ...
    PurchaseOrder, SalesTrip, Subcontractor, SubcontractorPayment, SubcontractorRetentionRelease, Supplier, SupplierPayment,
)
...
ENTITY_LABELS = {
    ...
    SubcontractorRetentionRelease: "إفراج ضمان",
